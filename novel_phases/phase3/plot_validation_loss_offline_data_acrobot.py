...
def main(args):
        ...
        for epoch in range(args.epochs):
            ...
            if (epoch + 1) % args.val_interval == 0:
                ...
                with torch.no_grad():
                    ...
                    print(f"y_val_proj shape: {y_val_proj.shape}")
                    print(f"mask_val shape: {mask_val.shape}")
                    print(f"val_outputs mean: {val_outputs.mean().item()}")
                    print(f"y_val_proj mean: {y_val_proj.mean().item()}")
                    print(f"mask_val mean: {mask_val.mean().item()}")
    ...
    print("Plot saved as validation_loss_vs_epoch_acrobot.png")
